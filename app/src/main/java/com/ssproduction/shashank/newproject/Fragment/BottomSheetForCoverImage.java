...
public class BottomSheetForCoverImage extends BottomSheetDialogFragment {
    ...
    public void setupDialog(Dialog mDialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.bottom_sheet_for_cover_image, null);
        ...
        selectProfile = (RelativeLayout) mDialog.findViewById(R.id.bottom_sheet_select_profile_cover);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if (resultCode == Activity.RESULT_OK){
                ...
                StorageReference filepath = mImageStorage.child("AvatarCoverImages").child(user_uid + ".jpg");
                final StorageReference thumb_filepath = mImageStorage.child("AvatarCoverImages").child("thumb")
                        .child(user_uid + ".jpg");
                            ...
                            uploadTask.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> thumbTask) {
                                    ...
                                    if (thumbTask.isSuccessful()){
                                        ...
                                        update_hashMap.put("avatar_cover_image", download_url);
                                        update_hashMap.put("avatar_cover_thumbImage", thumb_downloadUrl);
